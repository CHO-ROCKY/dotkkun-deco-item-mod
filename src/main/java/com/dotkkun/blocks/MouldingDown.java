...
public class MouldingDown extends BlockBase{
    public static final AxisAlignedBB MOULDING_DOWN_AABB = new AxisAlignedBB(0,0,0,0, 0,0);
    public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);

    public MouldingDown(String name, Material material) {
        super(name, material);
        setHardness(2.0f);
