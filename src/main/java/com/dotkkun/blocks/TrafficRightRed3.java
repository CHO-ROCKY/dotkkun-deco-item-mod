...
public class TrafficRightRed3 extends MultiBlockBase{
    public static final AxisAlignedBB TRAFFIC_RIGHT_RED_AABB = new AxisAlignedBB(0.1875D,0,0.1875D,0.75D,1,0.75D);
    public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);

    public TrafficRightRed3(String name, Material material) {
        super(name, material);
        setHardness(2.0f);
