...
public class TrafficRightGreen1 extends BlockBase{
    public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);

    public TrafficRightGreen1(String name, Material material) {
        super(name, material);
        setHardness(2.0f);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack){
        ...
        if(placer instanceof EntityPlayer){
            worldIn.setBlockState(pos1, ModBlocks.TRAFFIC_RIGHT_GREEN_2.getDefaultState().withProperty(FACING, placer.getAdjustedHorizontalFacing().getOpposite()));
            worldIn.setBlockState(pos2, ModBlocks.TRAFFIC_RIGHT_GREEN_3.getDefaultState().withProperty(FACING, placer.getAdjustedHorizontalFacing().getOpposite()));
        }
    }
